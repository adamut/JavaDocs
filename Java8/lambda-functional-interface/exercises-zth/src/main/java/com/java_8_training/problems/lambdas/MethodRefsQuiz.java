...
public class MethodRefsQuiz {
    ...
    public void stringToInteger(){
        ...
        //TO: refactor to use a method reference
    ...
    public void startsWithNumberQuiz() {
       ...
       // Predicate<String> startsWithNumber = (string) -> startsWithNumber(string);
        ...
        //sau facem startsWithNumber statica ca sa poata fi folosita fara instantiere si punem MethodRefsQuiz::startsWithNumber;
    ...
    public void formatText() {
        ...
        //TOD: refactor to use a method reference
      //  Function<String, String> formatText = (String title) -> formatter.format(title);
       // Function<String, String> formatText = TitleFormatter::format;
        Function<String, String> formatTxt = formatter::format;
        //TOD: use the formatText function to test the film title and print it to the console
        System.out.println(formatTxt.apply(filmTitle));
    }
