...
public class ExportFileServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        // TO 1: Iterate through Enumeration of parameter names from the request object and put inside paramsMap each parameter send from request
        ...
        while (enumeration.hasMoreElements()) {
            ...
            paramsMap.put(name, request.getParameterValues(name)[0]);
        }
        ...
        try (InputStream reportStream = getClass().getResourceAsStream(jasperPath)) {
            ...
            String fileName = "";
            fileName += request.getParameter("template") + "." + request.getParameter("fileType");
