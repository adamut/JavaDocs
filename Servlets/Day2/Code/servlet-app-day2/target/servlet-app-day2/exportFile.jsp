...
<script type="text/javascript">
    function exportFile() {
        ...
        if (username != null && username != "") {
            // TO 1: Use window.open to call ExportFileServlet using its mapping and the following request parameters: template, fileType and username
            ...
            // TO 1: Use window.open to call ExportFileServlet using its mapping and the following request parameters: template and fileType
            // TIP: Remember that the application context it's named servlet-app
