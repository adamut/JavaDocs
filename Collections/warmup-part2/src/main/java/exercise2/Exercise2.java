 ...
 *              For this exercise you need to follow in order, all the TOD steps.
 */
public class Exercise2 {
    ...
    public void addStudents(){
        ...
        // TO Exercise 2 a) In order to print the properties (fields) of Student class in a human readable way you should override
        // TO the toString() method from Student class -> TO Exercise 2 a)
        ...
        // TO Exercise 2 b) After you finished the Exercise 2 a) run the test file and look at the content ofSS
        // TO the collections studentSetWithoutEqualsAndHashCode and studentMapWithoutEqualsAndHashCode. What do you notice?
        // TOD Go to Exercise 2 c) from Student class and implement equals() method
        ...
        // TO Exercise 2 e) After you finished the Exercise 2 c) run the test file and look at the content of
        // TO the collections studentSetWithoutHashCode and studentMapWithoutHashCode. What do you notice?
        ...
        // TO Exercise 2 f) Go to TO Exercise 2 g) from Student class and implement hashCode() method
        ...
        // TO Exercise 2 i) After you finished the Exercise 2 g) run the test file and look at the content of
        // TO the collections studentSet and studentMap. What do you notice this time?
