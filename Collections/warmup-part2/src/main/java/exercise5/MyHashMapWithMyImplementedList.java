...
public class MyHashMapWithMyImplementedList {
    ...
    // TO uncomment the following line and add your MyImplementedList implementation to the project
    private MyImplementedList<MyImplementedList<MyEntry>> buckets;

    private final int BUCKET_ARRAY_SIZE = 16;

    public MyHashMapWithMyImplementedList() {
        // TODO
        buckets = new MyImplementedList<MyImplementedList<MyEntry>>(BUCKET_ARRAY_SIZE);
